...
//    private static OculusRiftReader oculus;
    ...
    public void initialize(AppStateManager stateManager, Application app) {
        ...
        //Adjusted to deferr the right viewport beeing viewd on left eye.
        camLeft.setViewPort(0.0f, 0.493f, 0.0f, 1.0f);
        camRight.setViewPort(0.507f, 1f, 0.0f, 1f);
...
//                        ((DirectionalLightShadowFilter)f2).setLight(((DirectionalLightShadowFilter)filter).getLight());
    ...
    {
        camControl.setCamHalfDistance(distance);
    }
}
